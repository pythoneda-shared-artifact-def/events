...
{
  description = "Nix flake for pythoneda-shared-artifact/events";
  inputs = rec {
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        repo = "events";
        version = "0.0.20";
        sha256 = "13yglpvr8h1iknj3p1lwm9bi5hyixwsfpfqd8f6szqhx5j3gvy49";
        pname = "${org}-${repo}";
      ...
      in rec {
        ...
        devShells = rec {
          default = pythoneda-shared-artifact-events-python312;
          ...
          pythoneda-shared-artifact-events-python312 = shared.devShell-for {
            banner = "${
                pythoneda-shared-pythonlang-banner.packages.${system}.pythoneda-shared-pythonlang-banner-python312
              }/bin/banner.sh";
            extra-namespaces = "";
            nixpkgs-release = nixpkgsRelease;
            package = packages.pythoneda-shared-artifact-events-python312;
          ...
          pythoneda-shared-artifact-events-python313 = shared.devShell-for {
            banner = "${
                pythoneda-shared-pythonlang-banner.packages.${system}.pythoneda-shared-pythonlang-banner-python313
              }/bin/banner.sh";
            extra-namespaces = "";
            nixpkgs-release = nixpkgsRelease;
            package = packages.pythoneda-shared-artifact-events-python313;
        ...
        packages = rec {
          ...
          pythoneda-shared-artifact-events-python312 =
            pythoneda-shared-artifact-events-for {
              python = pkgs.python312;
              pythoneda-shared-pythonlang-domain =
                pythoneda-shared-pythonlang-domain.packages.${system}.pythoneda-shared-pythonlang-domain-python312;
            };
          pythoneda-shared-artifact-events-python313 =
            pythoneda-shared-artifact-events-for {
              python = pkgs.python313;
              pythoneda-shared-pythonlang-domain =
                pythoneda-shared-pythonlang-domain.packages.${system}.pythoneda-shared-pythonlang-domain-python313;
