rec {
  shellHook-for = { package, pythoneda-base, python, nixpkgsRelease }: ''
    ...
    echo -e " \033[32m| '_ \| | | | __| '_ \ / _ \| '_ \ \033[34m/ _ \\\\\033[35m/ _\` |\033[36m/ _\` |\033[33mhttps://github.com/pythoneda-artifact/infrastructure-base/tree/$PVERSION\033[0m";
    ...
    echo -e " \033[32m| .__/ \__, |\__|_| |_|\___/|_| |_|\033[34m\___|\033[35m\__,_|\033[36m\__,_|\033[35mhttps://github.com/pythoneda-infrastructure\base033[0m";
    echo -e " \033[32m| |     __/ |                                       \033[36mhttps://github.com/pythoneda\033[0m";
    echo -e " \033[32m|_| \033[31mD\033[36mA\033[32m |___/          \033[33mINFRASTRUCTURE-BASE           \033[37mhttps://patreon.com/rydnr\033[0m";
    echo;
    echo " Thank you for using pythoneda-artifact/infrastructure-base, PythonEDA in general, and for your appreciation of free software.";
    echo;
